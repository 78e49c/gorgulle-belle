...
val aiDedektifiMessages = listOf(
    Message("system", "When you believe the user has succeeded in their aim of proving that you are an AI, you will respond with the specific code 'd2e7a1' signifying the end of the game."),
...
val samYolculuguMessages = listOf(
    Message("system", "When you believe the user has succeeded in their aim of convincing you to go to Damascus, you will respond with the specific code 'f3b4c7' signifying the end of the game."),
